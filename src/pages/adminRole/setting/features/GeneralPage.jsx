...
const GeneralPage = () => {
  ...
  return (
    <div className="flex flex-col items-start gap-6">
      ...
      <div className="w-[1136px] bg-white rounded-lg border border-gray-200 shadow-sm">
        <div className="p-6 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Icon Fix */}
            <div className="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center overflow-visible">
              <svg
                width="20"
                height="20"
                viewBox="0 0 16 16"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="h-11 px-3 bg-gray-50 border border-gray-200 rounded-md text-sm outline-none"
              />
            </div>
          ...
          {/* Button */}
          <button className="px-4 py-2 bg-emerald-900 text-white text-sm rounded-md w-fit">
            Save Changes
          </button>
