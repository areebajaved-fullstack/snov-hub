...
const ContactHero = () => {
  return (
    <div className="w-full">
      <section className="w-full relative bg-[#032125] overflow-hidden min-h-[400px] sm:h-[474px] md:h-[500px] lg:h-[550px]">
        {/* Background overlay */}
        ...
        <div className="relative h-full flex items-center justify-start px-4 sm:px-6 md:px-8 lg:px-12 xl:px-28 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="w-full max-w-4xl space-y-4 sm:space-y-6 md:space-y-8">
            {/* Badge */}
            <div className="w-24 sm:w-28 md:w-32 h-10 px-2 sm:px-3 md:px-4 bg-white/10 rounded-full outline outline-[1.26px] outline-offset-[-1.26px] outline-white/20 inline-flex justify-start items-center gap-2">
              ...
              <span className="text-slate-300 text-[0.75rem] sm:text-[0.8125rem] md:text-sm font-medium font-['Inter-400'] font-['Inter-sans'] leading-3 sm:leading-4 md:leading-5 whitespace-nowrap">Features</span>
            </div>
        
            {/* Heading */}
            <div className="w-full">
              <h1 className="text-transparent text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[4rem] font-semibold font-geist leading-tight sm:leading-[3rem] md:leading-[3.5rem] lg:leading-[4rem] xl:leading-[4.2rem] bg-clip-text bg-gradient-to-r from-white to-white/90">
            ...
            <div className="w-full max-w-2xl sm:max-w-3xl md:max-w-4xl">
              <p className="text-white/70 text-sm sm:text-base md:text-lg font-normal font-['Inter_Tight'] leading-5 sm:leading-6 md:leading-7 lg:leading-8">
              Everything you need to build intelligent AI agents that automate conversations and <span className="hidden sm:inline">deliver</span> exceptional customer experiences.
              </p>
            </div>
          </div>
        </div>
