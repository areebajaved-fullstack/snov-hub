...
const FeaturesShowcaseSection = () => {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 via-33% to-white py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Knowledge Powered Training Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-20 px-4">
          {/* Right Section - Knowledge Powered Training */}
          <div className="w-full lg:w-[568px] h-auto lg:h-[420px] relative">
            <div className="w-24 sm:w-28 lg:w-32 h-10 lg:h-12 left-0 top-0 absolute inline-flex justify-start items-center gap-2">
              <div className="w-10 h-10 lg:w-12 lg:h-12 px-2 lg:px-3 bg-emerald-400 rounded-xl lg:rounded-2xl flex justify-center items-center">
              ...
              <div className="flex-1 h-px relative bg-gradient-to-r from-slate-200 via-gray-300/95 via-7% to-black/0" />
            </div>
            <div className="w-full lg:w-[568px] h-auto lg:h-28 left-0 top-[60px] lg:top-[71.99px] absolute">
              <div className="w-full max-w-md lg:w-[477px] left-0 top-[-0.06px] absolute justify-start text-slate-900 text-2xl sm:text-3xl lg:text-4xl font-semibold font-['Inter_Tight'] leading-7 sm:leading-8 lg:leading-[52.80px]">Knowledge-Powered <br/> Training</div>
            </div>
            <div className="w-full lg:w-[568px] h-auto lg:h-24 left-0 top-[140px] lg:top-[201.57px] absolute">
              <div className="w-full max-w-lg lg:w-[530px] left-0 top-[-0.21px] absolute justify-start text-slate-500 text-sm sm:text-base lg:text-lg font-normal font-['Inter_Tight'] leading-6 sm:leading-7 lg:leading-8">Upload documents, wikis, and support articles. Our AI processes and structures your content for intelligent, contextual responses that feel natural and accurate.</div>
            </div>
            <div className="w-full lg:w-[568px] h-auto lg:h-32 left-0 top-[280px] lg:top-[340px] absolute">
              <div className="w-64 sm:w-72 h-12 pl-3 left-0 top-0 absolute bg-slate-50 rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200 inline-flex justify-start items-center gap-3">
                ...
                <div className="w-40 h-5 relative">
                  <div className="left-0 top-[-0.73px] absolute justify-start text-slate-900 text-[0.8125rem] font-medium font-['Inter_Tight'] leading-5">PDF, DOCX, TXT support</div>
                </div>
              </div>
              <div className="w-64 sm:w-72 h-12 pl-3 left-0 sm:left-[280px] lg:left-[291.99px] top-0 absolute bg-slate-50 rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200 inline-flex justify-start items-center gap-3">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-36 h-5 relative">
                  <div className="left-0 top-[-0.73px] absolute justify-start text-slate-900 text-[0.8125rem] font-medium font-['Inter_Tight'] leading-5">URL scraping & indexing</div>
                </div>
              </div>
              <div className="w-64 sm:w-72 h-12 pl-3 left-0 top-[70px] absolute bg-slate-50 rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200 inline-flex justify-start items-center gap-3">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-40 h-5 relative">
                  <div className="left-0 top-[-0.73px] absolute justify-start text-slate-900 text-[0.8125rem] font-medium font-['Inter_Tight'] leading-5">Automatic content updates</div>
                </div>
              </div>
              <div className="w-64 sm:w-72 h-12 pl-3 left-0 sm:left-[280px] lg:left-[291.99px] top-[70px] absolute bg-slate-50 rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200 inline-flex justify-start items-center gap-3">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.99139 4.16305C9.99237 3.83003 9.92675 3.50017 9.79838 3.19288C9.67002 2.88559 9.4815 2.60707 9.24392 2.37371C9.00634 2.14034 8.7245 1.95684 8.41496 1.83399C8.10542 1.71115 7.77445 1.65144 7.4415 1.65838C7.10855 1.66532 6.78035 1.73877 6.4762 1.87441C6.17205 2.01004 5.89809 2.20513 5.67044 2.44819C5.44279 2.69126 5.26605 2.97739 5.1506 3.28976C5.03515 3.60213 4.98333 3.93443 4.99819 4.26712C4.50878 4.39296 4.05442 4.62852 3.66952 4.95596C3.28463 5.28339 2.97929 5.69412 2.77664 6.15704C2.57398 6.61995 2.47932 7.12291 2.49983 7.62782C2.52033 8.13274 2.65547 8.62637 2.895 9.07132C2.47384 9.41347 2.14267 9.85334 1.93028 10.3527C1.71789 10.852 1.63072 11.3956 1.67635 11.9363C1.72198 12.477 1.89904 12.9984 2.19211 13.4551C2.48518 13.9117 2.88539 14.2899 3.35793 14.5566C3.29958 15.0081 3.3344 15.4667 3.46025 15.9042C3.5861 16.3417 3.8003 16.7487 4.08962 17.1002C4.37895 17.4517 4.73725 17.7401 5.14241 17.9476C5.54757 18.1552 5.99098 18.2775 6.44525 18.307C6.89953 18.3365 7.35503 18.2725 7.78361 18.119C8.2122 17.9656 8.60477 17.7259 8.9371 17.4148C9.26942 17.1036 9.53443 16.7277 9.71576 16.3101C9.8971 15.8926 9.9909 15.4423 9.99139 14.9871V4.16305Z" stroke="#31C48D" strokeWidth="1.66523" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M9.99122 4.16305C9.99024 3.83003 10.0559 3.50017 10.1842 3.19288C10.3126 2.88559 10.5011 2.60707 10.7387 2.37371C10.9763 2.14034 11.2581 1.95684 11.5677 1.83399C11.8772 1.71115 12.2082 1.65144 12.5411 1.65838C12.8741 1.66532 13.2023 1.73877 13.5064 1.87441C13.8106 2.01004 14.0845 2.20513 14.3122 2.44819C14.5398 2.69126 14.7166 2.97739 14.832 3.28976C14.9475 3.60213 14.9993 3.93443 14.9844 4.26712C15.4738 4.39296 15.9282 4.62852 16.3131 4.95596C16.698 5.28339 17.0033 5.69412 17.206 6.15704C17.4086 6.61995 17.5033 7.12291 17.4828 7.62782C17.4623 8.13274 17.3271 8.62637 17.0876 9.07132C17.5088 9.41347 17.8399 9.85334 18.0523 10.3527C18.2647 10.852 18.3519 11.3956 18.3063 11.9363C18.2606 12.477 18.0836 12.9984 17.7905 13.4551C17.4974 13.9117 17.0972 14.2899 16.6247 14.5566C16.683 15.0081 16.6482 15.4667 16.5224 15.9042C16.3965 16.3417 16.1823 16.7487 15.893 17.1002C15.6037 17.4517 15.2454 17.7401 14.8402 17.9476C14.435 18.1552 13.9916 18.2775 13.5374 18.307C13.0831 18.3365 12.6276 18.2725 12.199 18.119C11.7704 17.9656 11.3778 17.7259 11.0455 17.4148C10.7132 17.1036 10.4482 16.7277 10.2668 16.3101C10.0855 15.8926 9.99171 15.4423 9.99122 14.9871V4.16305Z" stroke="#31C48D" strokeWidth="1.66523" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M12.4894 10.824C11.7903 10.5781 11.1799 10.1304 10.7353 9.53761C10.2907 8.94479 10.0318 8.23345 9.9915 7.49353C9.95116 8.23345 9.69232 8.94479 9.2477 9.53761C8.80309 10.1304 8.19268 10.5781 7.49365 10.824" stroke="#31C48D" strokeWidth="1.66523" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <div className="w-44 h-5 relative">
                  <div className="left-0 top-[-0.73px] absolute justify-start text-slate-900 text-[0.8125rem] font-medium font-['Inter_Tight'] leading-5">Smart chunking & embedding</div>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full lg:w-[568px] h-auto lg:h-[477px] p-4 lg:p-8 bg-white rounded-[32px] shadow-[0px_25px_50px_-12px_rgba(0,188,125,0.10)] outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200 inline-flex flex-col justify-start items-start">
            <div className="w-full lg:w-[502px] h-auto lg:h-96 flex flex-col justify-start items-start gap-4">
              ...
              <div className="self-stretch h-16 px-3 sm:px-4 bg-gradient-to-br from-emerald-100 via-emerald-100 via-11% to-emerald-200 rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-green-300 inline-flex justify-start items-center gap-2 sm:gap-3">
                ...
                <div className="flex-1 h-6 relative">
                  <div className="left-0 top-0 absolute justify-start text-slate-900 text-xs font-medium font-['Inter_Tight'] leading-4">URL scraping & indexing</div>
                  <div className="left-0 top-[17.97px] absolute justify-start text-slate-500 text-[10px] font-normal font-['Inter_Tight'] leading-4">22 of 24 files completed </div>
                </div>
                <div className="w-6 h-4 relative">
                  <div className="left-0 top-[-0.73px] absolute justify-start text-green-600 text-xs font-normal font-['Inter_Tight'] leading-4">92%</div>
                </div>
              </div>
              <div className="self-stretch h-auto lg:h-60 relative">
                <div className="w-48 sm:w-56 lg:w-60 h-28 left-[-0.20px] top-[-0.06px] absolute bg-white rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200">
                  <div className="w-8 h-8 px-2 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[8px] sm:top-[10px] lg:top-[13.26px] absolute bg-blue-100 rounded-[10px] inline-flex justify-center items-center">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="w-24 sm:w-28 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[36px] sm:top-[40px] lg:top-[48.23px] absolute justify-start text-slate-900 text-xs font-medium font-['Inter_Tight'] leading-4">Product_Guide.pdf<br/></div>
                  <div className="w-20 sm:w-24 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[52px] sm:top-[56px] lg:top-[63.74px] absolute justify-start text-slate-500 text-[10px] font-normal font-['Inter_Tight'] leading-4">Documentation<br/></div>
                  <div className="w-56 h-3.5 left-[13.26px] top-[83.17px] absolute inline-flex justify-start items-start">
                    <div className="flex-1 justify-start text-slate-400 text-[10px] font-normal font-['Inter_Tight'] leading-4">2.4 MB</div>
                  </div>
                </div>
                <div className="w-48 sm:w-56 lg:w-60 h-28 left-[180px] sm:left-[220px] lg:left-[256.75px] top-0 absolute bg-white rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200">
                  <div className="w-8 h-8 px-2 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[8px] sm:top-[10px] lg:top-[13.26px] absolute bg-indigo-100 rounded-[10px] inline-flex justify-center items-center">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="w-24 sm:w-28 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[36px] sm:top-[40px] lg:top-[48px] absolute justify-start text-slate-900 text-xs font-medium font-['Inter_Tight'] leading-4">FAQ_Guide.pdf<br/></div>
                  <div className="w-20 sm:w-24 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[52px] sm:top-[56px] lg:top-[63.97px] absolute justify-start text-slate-500 text-[10px] font-normal font-['Inter_Tight'] leading-4">Help Center<br/></div>
                  <div className="w-56 h-3.5 left-[13.26px] top-[83.17px] absolute inline-flex justify-start items-start">
                    <div className="flex-1 justify-start text-slate-400 text-[10px] font-normal font-['Inter_Tight'] leading-4">1.8 MB</div>
                  </div>
                </div>
                <div className="w-48 sm:w-56 lg:w-60 h-28 left-0 top-[140px] sm:top-[150px] lg:top-[163.44px] absolute bg-white rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200">
                  <div className="w-8 h-8 px-2 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[8px] sm:top-[10px] lg:top-[13.26px] absolute bg-pink-100 rounded-[10px] inline-flex justify-center items-center">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="w-24 sm:w-28 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[36px] sm:top-[40px] lg:top-[48px] absolute justify-start text-slate-900 text-xs font-medium font-['Inter_Tight'] leading-4">API_Reference.pdf<br/></div>
                  <div className="w-20 sm:w-24 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[52px] sm:top-[56px] lg:top-[63.97px] absolute justify-start text-slate-500 text-[10px] font-normal font-['Inter_Tight'] leading-4">Technical Docs<br/></div>
                  <div className="w-56 h-3.5 left-[13.26px] top-[83.17px] absolute inline-flex justify-start items-start">
                    <div className="flex-1 justify-start text-slate-400 text-[10px] font-normal font-['Inter_Tight'] leading-4">3.2 MB</div>
                  </div>
                </div>
                <div className="w-48 sm:w-56 lg:w-60 h-28 left-[180px] sm:left-[220px] lg:left-[256.75px] top-[140px] sm:top-[150px] lg:top-[163.44px] absolute bg-white rounded-2xl outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200">
                  <div className="w-8 h-8 px-2 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[8px] sm:top-[10px] lg:top-[13.26px] absolute bg-amber-100 rounded-[10px] inline-flex justify-center items-center">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="w-24 sm:w-28 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[36px] sm:top-[40px] lg:top-[48px] absolute justify-start text-slate-900 text-xs font-medium font-['Inter_Tight'] leading-4">User_Manual.docx<br/></div>
                  <div className="w-20 sm:w-24 h-4 left-[8px] sm:left-[10px] lg:left-[13.26px] top-[52px] sm:top-[56px] lg:top-[63.97px] absolute justify-start text-slate-500 text-[10px] font-normal font-['Inter_Tight'] leading-4">Getting Started<br/></div>
                  <div className="w-56 h-3.5 left-[13.26px] top-[83.17px] absolute inline-flex justify-start items-start">
                    <div className="flex-1 justify-start text-slate-400 text-[10px] font-normal font-['Inter_Tight'] leading-4">1.5 MB</div>
                  </div>
                </div>
              </div>
              <div className="self-stretch h-9 border-t-[1.26px] border-slate-200 inline-flex justify-between items-center">
                <div className="w-32 h-4 mt-10 flex justify-start items-center gap-2">
                  ...
                  <div className="w-28 h-4 relative">
                    <div className="left-0 top-[-0.73px] absolute justify-start text-slate-500 text-xs font-normal font-['Inter_Tight'] leading-4">Processing complete</div>
                  </div>
                </div>
                <div className="w-12 h-4 mt-10 relative">
                  <div className="left-0 top-[-0.73px] absolute justify-start text-emerald-400 text-xs font-medium font-['Inter_Tight'] leading-4">View all</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-20 px-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="text-slate-900 text-2xl sm:text-3xl lg:text-4xl font-semibold font-['Inter_Tight'] leading-7 sm:leading-8 lg:leading-[52.80px]">
                <span className="block">Multi-Channel</span>
                <span className="block">Deployment</span>
              </h2>
              <p className="text-slate-500 text-sm sm:text-base lg:text-lg font-normal font-['Inter_Tight'] leading-6 sm:leading-7 lg:leading-8 max-w-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 mb-20 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 mb-20 px-4">
          ...
          <div className="w-full lg:w-[568px] h-[420px] lg:h-96 relative">
            <div className="w-full lg:w-[568px] h-[380px] lg:h-96 left-0 top-[35.02px] absolute">
              <div className="w-full lg:w-[568px] h-[380px] lg:h-96 left-0 top-0 absolute rounded-[32px] blur-2xl bg-gradient-to-br from-slate-50 to-gray-100" />
              <div className="w-full lg:w-[568px] h-[380px] lg:h-96 p-6 lg:p-8 left-0 top-0 absolute bg-white rounded-[32px] shadow-[0px_25px_50px_-12px_rgba(0,188,125,0.10)] outline outline-[1.26px] outline-offset-[-1.26px] outline-slate-200 inline-flex flex-col justify-center items-center">
                <div className="w-full max-w-sm lg:w-96 h-64 lg:h-72 relative">
                  {/* Connection Lines */}
                  <div className="hidden lg:block absolute left-[171.87px] top-[51.12px]">
                  ...
                  <div className="hidden lg:block absolute left-[210.36px] top-[51.12px]">
                  ...
                  <div className="hidden lg:block absolute left-[97.57px] top-[51.12px]">
                  ...
                  <div className="hidden lg:block absolute left-[247.06px] top-[51.12px]">
                  ...
                  <div className="hidden lg:block absolute left-[23.27px] top-[51.12px]">
                    <svg width="76" height="35" viewBox="0 0 76 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Service Icons */}
                  <div className="absolute left-[222.70px] lg:left-[222.70px] top-[-1.04px] bg-white rounded-3xl shadow-[0px_0px_3.747990369796753px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-0.94px] outline-slate-100 inline-flex justify-start items-start gap-2 p-2.5">
                    <svg width="16" height="16" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.3335 6.77326H12.392L12.3627 6.74325L14.411 4.64254V4.59752C12.6846 3.03699 10.2998 2.49681 8.09063 3.17204C5.88144 3.84727 4.1843 5.64788 3.56982 7.92866C3.59909 7.91365 3.64298 7.89864 3.68687 7.89864C4.44765 7.38847 5.35474 7.08837 6.30572 7.08837C6.62759 7.08837 6.93483 7.11838 7.24207 7.1784C7.2567 7.1634 7.27133 7.1634 7.28596 7.1634C8.6027 5.67789 10.8265 5.49783 12.3481 6.77326H12.3335Z" fill="#EA4535"/>
                  ...
                  {/* Connection Points */}
                  <div className="hidden lg:block absolute left-[244.37px] top-[48.42px]">
                  ...
                  <div className="hidden lg:block absolute left-[319.56px] top-[48.42px]">
                    <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.90527 2.69043C4.90519 3.91794 3.91124 4.91211 2.68652 4.91211C1.46199 4.91189 0.468833 3.9178 0.46875 2.69043C0.46875 1.46299 1.46194 0.468973 2.68652 0.46875C3.91129 0.46875 4.90527 1.46285 4.90527 2.69043Z" fill="white" stroke="#CBD5E1" strokeWidth="0.936998"/>
                    </svg>
                  </div>
                  ...
                  {/* Shield Icon */}
                  <div className="absolute left-[295.83px] lg:left-[295.83px] top-[-3.38px] bg-white rounded-3xl shadow-[0px_0px_3.747990369796753px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-0.94px] outline-slate-100 inline-flex flex-col justify-start items-start gap-2 p-2.5">
                  ...
                  {/* Teams Icon */}
                  <div className="absolute left-[146.59px] lg:left-[146.59px] top-[-1.28px] bg-white rounded-3xl shadow-[0px_0px_3.747990369796753px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-0.94px] outline-slate-100 inline-flex justify-start items-start gap-2 p-2.5">
                  ...
                  <div className="hidden lg:block absolute left-[169.18px] top-[48.42px]">
                    <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.90527 2.69043C4.90519 3.91794 3.91124 4.91211 2.68652 4.91211C1.46199 4.91189 0.468833 3.9178 0.46875 2.69043C0.46875 1.46299 1.46194 0.468973 2.68652 0.46875C3.91129 0.46875 4.90527 1.46285 4.90527 2.69043Z" fill="white" stroke="#CBD5E1" strokeWidth="0.936998"/>
                    </svg>
                  </div>
                  ...
                  {/* Salesforce Icon */}
                  <div className="absolute left-[68.39px] lg:left-[68.39px] top-[-5.39px] bg-white rounded-3xl shadow-[0px_0px_3.747990369796753px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-0.94px] outline-slate-100 inline-flex justify-start items-start gap-2 p-3.5">
                  ...
                  {/* More Connection Points */}
                  <div className="hidden lg:block absolute left-[94.88px] top-[48.42px]">
                    <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.90527 2.69043C4.90519 3.91794 3.91124 4.91211 2.68652 4.91211C1.46199 4.91189 0.468833 3.9178 0.46875 2.69043C0.46875 1.46299 1.46194 0.468973 2.68652 0.46875C3.91129 0.46875 4.90527 1.46285 4.90527 2.69043Z" fill="white" stroke="#CBD5E1" strokeWidth="0.936998"/>
                    </svg>
                  </div>
                  ...
                  {/* Slack Icon */}
                  <div className="absolute left-[-1.09px] lg:left-[-1.09px] top-[-1.05px] bg-white rounded-3xl shadow-[0px_0px_3.747990369796753px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-0.94px] outline-slate-100 inline-flex justify-start items-start gap-2 p-3.5">
                  ...
                  {/* More Connection Points */}
                  <div className="hidden lg:block absolute left-[20.59px] top-[48.42px]">
                    <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.90527 2.69043C4.90519 3.91794 3.91124 4.91211 2.68652 4.91211C1.46199 4.91189 0.468833 3.9178 0.46875 2.69043C0.46875 1.46299 1.46194 0.468973 2.68652 0.46875C3.91129 0.46875 4.90527 1.46285 4.90527 2.69043Z" fill="white" stroke="#CBD5E1" strokeWidth="0.936998"/>
                    </svg>
                  </div>
                  <div className="hidden lg:block absolute left-[207.67px] top-[111.08px]">
                    <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="absolute left-4 sm:left-8 lg:left-[86.67px] top-[100px] sm:top-[110px] lg:top-[117.88px] bg-white rounded-xl outline outline-1 outline-offset-[-0.94px] outline-slate-100 inline-flex flex-col justify-center items-center gap-3 sm:gap-4 lg:gap-5 p-4 sm:p-5 lg:p-6 w-64 sm:w-80 lg:w-auto">
                    <div className="self-stretch flex flex-col justify-start items-center gap-3">
                      <div className="inline-flex justify-center items-center gap-3">
                        <div className="flex justify-start items-center gap-4">
                          <div className="flex justify-start items-center gap-1">
                            <div className="w-6 h-6 relative bg-emerald-950 rounded-sm overflow-hidden">
                              <img src="/src/assets/images/Navigation.png" alt="Navigation" className="w-full h-full object-cover" />
                            </div>
                          </div>
                        </div>
                        <div className="text-slate-900 text-sm sm:text-base lg:text-base font-medium font-['Inter_Tight'] leading-5 sm:leading-6 lg:leading-6 tracking-wide">Data Authorization</div>
                      </div>
                      <div className="w-48 sm:w-52 lg:w-52 text-center text-slate-500 text-xs sm:text-sm lg:text-sm font-normal font-['Inter_Tight'] leading-4 sm:leading-5 lg:leading-5 tracking-wide">Authorize AI Agent with Role-Based Access</div>
                    </div>
                    <div className="self-stretch inline-flex justify-end items-center gap-3">
                      <div className="w-20 sm:w-24 lg:w-24 px-2 sm:px-3 lg:px-3 py-1.5 sm:py-2 lg:py-2 rounded-lg outline outline-1 outline-offset-[-0.94px] outline-slate-300 flex justify-center items-center gap-2">
                        <div className="text-slate-900 text-xs sm:text-sm lg:text-sm font-semibold font-['Inter_Tight'] leading-4 sm:leading-5 lg:leading-5 tracking-wide">Deny</div>
                      </div>
                      <div className="w-20 sm:w-24 lg:w-24 px-2 sm:px-3 lg:px-3 py-1.5 sm:py-2 lg:py-2 bg-emerald-950 rounded-lg flex justify-center items-center gap-2">
                        <div className="text-white text-xs sm:text-sm lg:text-sm font-semibold font-['Inter_Tight'] leading-4 sm:leading-5 lg:leading-5 tracking-wide">Authorize</div>
                      </div>
                    </div>
                  </div>
                </div>
