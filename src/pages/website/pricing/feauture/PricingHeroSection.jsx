...
const PricingHeroSection = () => {
  return (
    <div className="w-full">
      <section className="w-full relative bg-[#032125] overflow-hidden h-[300px] xs:h-[350px] sm:h-[400px] md:h-[450px] lg:h-[474px]">
        {/* Background overlay */}
        <div className="absolute inset-0 opacity-5" aria-hidden="true" />
        
        <div className="relative h-full flex items-center justify-start px-3 xs:px-4 sm:px-6 md:px-8 lg:px-12 xl:px-28 py-6 xs:py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24">
          <div className="w-full max-w-4xl space-y-3 xs:space-y-4 sm:space-y-6 md:space-y-8">
            {/* Badge */}
            ...
            {/* Heading */}
            <div className="w-full">
              <h1 className="text-transparent text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[64px] font-semibold font-geist leading-tight xs:leading-tight sm:leading-tight md:leading-tight lg:leading-tight xl:leading-tight bg-clip-text bg-gradient-to-r from-white to-white/90">
            ...
            <div className="w-full max-w-2xl sm:max-w-3xl md:max-w-4xl">
              <p className="text-white/70 text-xs xs:text-sm sm:text-base md:text-[1rem] lg:text-lg font-normal font-['Inter-400'] font-['Inter-sans'] leading-4 xs:leading-5 sm:leading-6 md:leading-7 lg:leading-8">
