...
{/* newv */}
                    ...
                    <div className="hidden lg:flex items-center gap-[10px] flex-shrink-0">
                        <Link to="/login" className="text-[#061A22] font-semibold text-[12px] sm:text-[14px] lg:text-[16px] w-[80px] sm:w-[100px] lg:w-[120px] py-[8px] sm:py-[10px] lg:py-[11px] rounded-[8px] sm:rounded-[10px] border border-[#E5E7EB] hover:bg-emerald-50 hover:border-emerald-300 hover:text-emerald-600 transition-all duration-200 flex items-center justify-center">
                            Login
                        </Link>
                ...
                <div className="lg:hidden px-4 sm:px-6 pb-6 sm:pb-8 bg-white border-t">
                    <div className="flex flex-col gap-4 sm:gap-5 mt-4">
                        ...
                        <div className="flex flex-col gap-3 mt-4 sm:mt-5 pt-4 sm:pt-5 border-t">
                            <Link to="/login" className="border px-[18px] sm:px-[22px] py-[9px] sm:py-[11px] rounded-[8px] sm:rounded-[10px] hover:bg-emerald-50 hover:border-emerald-200 transition-colors duration-200 flex items-center justify-center">
                                Login
                            </Link>
