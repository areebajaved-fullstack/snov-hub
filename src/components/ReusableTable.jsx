          ...
          <thead>
            <tr className="bg-gray-100/50 border-b border-gray-200 h-12">
              {columns.map((col, index) => (
                <th
                  key={index}
                  className="px-6 text-left text-gray-500 text-xs font-medium font-poppins whitespace-nowrap"
            ...
            {data.map((row, rowIndex) => (
              ...
              >
                {columns.map((col, colIndex) => (
                  <td
                    key={colIndex}
                    className="px-6 text-sm text-slate-900 font-poppins whitespace-nowrap"
                  >
          ...
          >
            {columns.map((col, i) => (
              <div key={i} className="flex justify-between items-center py-1">
                <span className="text-gray-500 text-xs text-[#6B7280] font-poppins">
                  {col.header}
                </span>
